...
from infra_dingtalk.dingtalk.core.utils import to_text
...
class Role(DingTalkBaseAPI):
    def simplelist(self, role_id, offset=0, size=20):
        ...
        return self._top_request(
            "dingtalk.corp.role.simplelist", {"role_id": role_id, "offset": offset, "size": size}
        )
    ...
    def list(self, offset=0, size=20):
        ...
        :return:
        """
        return self._top_request("dingtalk.corp.role.list", {"offset": offset, "size": size})
    ...
    def deleterole(self, role_id):
        ...
        :return:
        """
        return self._top_request("dingtalk.corp.role.deleterole", {"role_id": role_id})
    ...
    def getrole(self, role_id):
        ...
        :param role_id: 角色id
        """
        return self._top_request("dingtalk.oapi.role.getrole", {"roleId": role_id})
    ...
    def add_role(self, role_name, group_id):
        ...
        """
        return self.post("/role/add_role", {"roleName": role_name, "groupId": group_id})
    ...
    def update_role(self, role_name, group_id):
        ...
        :param group_id: 角色组id
        """
        return self.post("/role/update_role", {"roleName": role_name, "groupId": group_id})
    ...
    def add_role_group(self, name):
        ...
        """
        return self.post(
            "/role/add_role_group", {"name": name}, result_processor=lambda x: x["groupId"]
        )
