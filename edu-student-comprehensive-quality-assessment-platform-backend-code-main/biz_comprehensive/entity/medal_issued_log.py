...
from biz_comprehensive.entity.history.medal_issued_log_history import MedalIssuedLogHistoryEntity


class MedalIssuedLogEntity(VersionedEntity):
    """
    勋章发放日志
    """

    __tablename__ = "st_medal_issued_log"
    __table_args__ = {"comment": "勋章发放日志"}
    __history_entity__ = MedalIssuedLogHistoryEntity
