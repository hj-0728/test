...
from biz_comprehensive.entity.history.observation_point_points_snapshot_history import (
    ObservationPointPointsSnapshotHistoryEntity,
)


class ObservationPointPointsSnapshotEntity(VersionedEntity):
    """
    观测点积分快照
    """

    __tablename__ = "st_observation_point_points_snapshot"
    __table_args__ = {"comment": "观测点积分快照"}
    __history_entity__ = ObservationPointPointsSnapshotHistoryEntity
...
Index(
    "idx_observation_point_points_snapshot_owner",
    ObservationPointPointsSnapshotEntity.owner_res_category,
    ObservationPointPointsSnapshotEntity.owner_res_id,
)
