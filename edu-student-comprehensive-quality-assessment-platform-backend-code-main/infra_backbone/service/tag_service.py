...
class TagService:
    ...
    def update_related_relationship(
        ...
        if old_tag_ownership_info:
            if (
                old_tag_ownership_info.tag_ownership_id
                != tag_ownership_relationship.tag_ownership_id
            ):
    ...
    def delete_tag_ownership_relationship(
        self, tag_ownership_relationship_id: str, transaction: Transaction
    ):
        """
