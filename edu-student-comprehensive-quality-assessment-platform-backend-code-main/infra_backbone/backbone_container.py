...
class BackboneContainer(containers.DeclarativeContainer):
    ...
    distributed_task_log_repository = providers.ThreadLocalSingleton(
        DistributedTaskLogRepository, db_session=uow.provided.db_session
    )  # type: ignore
    ...
    file_public_link_repository = providers.ThreadLocalSingleton(
        FilePublicLinkRepository, db_session=uow.provided.db_session
    )
    ...
    storage_service = providers.ThreadLocalSingleton(
        ...
        file_public_link_repository=file_public_link_repository,
    )
    ...
    data_permission_service = providers.ThreadLocalSingleton(
    ...
    distributed_task_log_service = providers.ThreadLocalSingleton(
        DistributedTaskLogService,
        distributed_task_log_repository=distributed_task_log_repository,
    )  # type: ignore
