...
class SchedulerJobLogEntity(BasicEntity):
    ...
    execute_started_on = Column(DateTime(timezone=True), nullable=False, comment="开始时间")
    execute_ended_on = Column(DateTime(timezone=True), nullable=False, comment="结束时间")
