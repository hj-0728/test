...
Index(
    ...
    RoutePermitHistoryEntity.commenced_on,
    RoutePermitHistoryEntity.ceased_on.desc(),
    unique=True,
)


Index(
    "idx_route_permit_history_permitted_resource",
    RoutePermitHistoryEntity.permitted_resource_category,
    RoutePermitHistoryEntity.permitted_resource_id,
)
