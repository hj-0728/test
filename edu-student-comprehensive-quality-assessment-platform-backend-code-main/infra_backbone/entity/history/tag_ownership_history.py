...
Index(
    ...
    TagOwnershipHistoryEntity.commenced_on,
    TagOwnershipHistoryEntity.ceased_on.desc(),
    unique=True,
)


Index(
    "idx_tag_ownership_history_resource_info",
    TagOwnershipHistoryEntity.owner_category,
    TagOwnershipHistoryEntity.owner_id,
)
