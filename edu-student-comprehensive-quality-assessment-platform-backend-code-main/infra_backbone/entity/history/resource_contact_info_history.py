...
Index(
    ...
    ResourceContactInfoHistoryEntity.commenced_on,
    ResourceContactInfoHistoryEntity.ceased_on.desc(),
    unique=True,
)


Index(
    "idx_resource_contact_info_history_resource_info",
    ResourceContactInfoHistoryEntity.resource_category,
    ResourceContactInfoHistoryEntity.resource_id,
)
