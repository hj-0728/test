...
from infra_backbone.model.scheduler_job_model import EnumSchedulerJobTriggerType
...
def add_scheduler_job(
    ...
    if (
        ...
        and hasattr(job_param, "trigger_type")
    ):
        if job_param.trigger_type == EnumSchedulerJobTriggerType.INTERVAL.name:
        ...
        elif job_param.trigger_type == EnumSchedulerJobTriggerType.CRON.name:
