    ...
    setup() {
      ...
      function filterItem(list: RouteLocationMatched[]) {
        return filter(list, (item) => {
          ...
          if (
            userInfo.currentRole.code === 'TEACHER' &&
            (path === '/account-manage/teacher-list' || path === '/evaluation-record/about-me')
          ) {
            return false;
          }
          if (userInfo.currentRole.code === 'ADMIN' && path === '/evaluation-record/about-me') {
            return false;
          }
