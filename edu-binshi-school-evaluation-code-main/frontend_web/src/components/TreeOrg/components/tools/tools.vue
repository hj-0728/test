<template>
  <div class="zm-tree-handle">
    ...
    <div v-if="tools.expand" @click="handleExpand" :title="expandTitle" class="zm-tree-handle-item">
      <span class="zm-tree-svg">
        <Icon v-if="expanded" icon="ant-design:fullscreen-exit-outlined" />
    ...
    >
      <span class="zm-tree-svg">
        <Icon v-if="fullscreen" icon="ri:fullscreen-exit-fill" />
        <Icon v-else icon="ri:fullscreen-fill" />
      </span>
    </div>
  </div>
</template>
