...
class ReportRecordHistoryEntity(HistoryEntity):
    """
    word表格样式配置（历史实体类）
    """

    __tablename__ = "st_report_record_history"
    __table_args__ = {"comment": "报告记录（历史）"}
...
Index(
    "idx_report_record_history_time_range",
    ReportRecordHistoryEntity.id,
    ReportRecordHistoryEntity.begin_at,
    ReportRecordHistoryEntity.end_at.desc(),
    unique=True,
)
