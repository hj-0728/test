...
from infra_dingtalk.dingtalk.core.exceptions import (
    InvalidCorpIdOrSuiteKeyException,
    InvalidSignatureException,
)
from infra_dingtalk.dingtalk.core.utils import DingTalkSigner, random_string, to_binary, to_text
from infra_dingtalk.dingtalk.crypto.base import BasePrpCrypto
...
class BaseDingTalkCrypto(object):
    ...
    def _decrypt_encrypt_str(self, signature, timestamp, nonce, encrypt_str, crypto_class=None):
    ...
    def _encrypt_message(self, msg, nonce=None, timestamp=None, crypto_class=None):
