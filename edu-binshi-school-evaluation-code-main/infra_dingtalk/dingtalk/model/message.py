...
class LinkBody(BodyBase):
    ...
    def __init__(self, message_url, pic_url, title, text, **kwargs):
        ...
        :param text: 消息描述
        """
        super(LinkBody, self).__init__(
            messageUrl=message_url, picUrl=pic_url, title=title, text=text, **kwargs
        )
...
class OaBodyContent(BodyBase):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(OaBodyContent, self).__init__(
            title=title,
            content=content,
            author=author,
            image=image,
...
class SingleActionCardBody(ActionCardBody):
    ...
    def __init__(self, title, markdown, single_title, single_url, **kwargs):
        ...
        :param kwargs:
        """
        super(SingleActionCardBody, self).__init__(
            title=title,
            markdown=markdown,
...
class BtnActionCardBody(ActionCardBody):
    ...
    def __init__(self, title, markdown, btn_orientation, btn_list=(), **kwargs):
        ...
        super(BtnActionCardBody, self).__init__(
            title=title,
            markdown=markdown,
