...
class ExtContact(DingTalkBaseAPI):
    def listlabelgroups(self, offset=0, size=100):
        ...
        return self._top_request(
            "dingtalk.oapi.extcontact.listlabelgroups", {"size": size, "offset": offset}
        )
    ...
    def list(self, offset=0, size=100):
        ...
        :param offset: 偏移位置
        """
        return self._top_request("dingtalk.oapi.extcontact.list", {"size": size, "offset": offset})
    ...
    def get(self, user_id):
        ...
        """
        return self._top_request("dingtalk.oapi.extcontact.get", {"user_id": user_id})
    ...
    def delete(self, user_id):
        ...
        :param user_id: 用户id
        """
        return self._top_request("dingtalk.oapi.extcontact.delete", {"user_id": user_id})
