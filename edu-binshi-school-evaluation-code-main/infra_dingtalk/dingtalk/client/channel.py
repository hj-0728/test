...
from infra_dingtalk.dingtalk.storage.cache import ChannelCache
...
class ChannelClient(BaseClient):
    ...
    def get_user_list(self, offset=0, size=100):
        ...
        :return:
        """
        return self.get("/channel/user/list", {"offset": offset, "size": size})
    ...
    def get_by_openid(self, openid):
        ...
        :return:
        """
        return self.get("/channel/user/get_by_openid", {"openid": openid})
    ...
    def get_by_code(self, code):
        ...
        :return:
        """
        return self.get("/channel/user/get_by_code", {"code": code})
