...
from infra_dingtalk.dingtalk.client import DingTalkClient
from infra_dingtalk.dingtalk.client.base import BaseClient
from infra_dingtalk.dingtalk.client.channel import ChannelClient
from infra_dingtalk.dingtalk.core.constants import SuitePushType
from infra_dingtalk.dingtalk.core.utils import json_loads, to_text
from infra_dingtalk.dingtalk.crypto import DingTalkCrypto
from infra_dingtalk.dingtalk.storage.cache import ISVCache
...
class ISVDingTalkClient(DingTalkClient):
    def __init__(self, corp_id, isv_client):
        super(ISVDingTalkClient, self).__init__(
            corp_id,
            "isv_auth:" + isv_client.suite_key,
            isv_client.storage,
            isv_client.timeout,
            isv_client.auto_retry,
        )
...
class ISVChannelClient(ChannelClient):
    def __init__(self, corp_id, isv_client):
        super(ISVChannelClient, self).__init__(
            corp_id,
            "isv_channel:" + isv_client.suite_key,
            isv_client.storage,
            isv_client.timeout,
            isv_client.auto_retry,
        )
...
class ISVClient(BaseClient):
    ...
    def get_permanent_code(self, tmp_auth_code):
        ...
        permanent_code_data = self.post(
            "/service/get_permanent_code", {"tmp_auth_code": tmp_auth_code}
        )
    ...
    def get_auth_info(self, corp_id):
        ...
        """
        return self.post(
            "/service/get_auth_info", {"auth_corpid": corp_id, "suite_key": self.suite_key}
        )
    ...
    def reauth_corp(self, app_id, corpid_list):
        ...
        :return:
        """
        return self.post("/service/reauth_corp", {"app_id": app_id, "corpid_list": corpid_list})
    ...
    def set_corp_ipwhitelist(self, corp_id, ip_whitelist):
        ...
        """
        return self.post(
            "/service/set_corp_ipwhitelist", {"auth_corpid": corp_id, "ip_whitelist": ip_whitelist}
        )
    ...
    def get_channel_token_by_corpid(self, corp_id):
        ...
        return self.post(
            ...
            {
                "auth_corpid": corp_id,
                "ch_permanent_code": self.get_ch_permanent_code_from_cache(corp_id),
            },
        )
