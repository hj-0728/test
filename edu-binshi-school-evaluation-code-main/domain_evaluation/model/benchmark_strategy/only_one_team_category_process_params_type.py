...
class OnlyOneTeamCategoryProcessParamsType(BasicInputProcessParamsType):
    ...
    def to_built_input_node(self, benchmark_id: str) -> BuiltBenchmarkNode:
        ...
        input_node["filler_calc_method"] = "TeamCategoryBenchmark"
        input_node["filler_calc_context"] = {"team_category_id": self.team_category_id}
        input_exec_node = {
